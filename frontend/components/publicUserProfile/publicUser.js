...
const publicUserProfile = (props) => {
    ...
    const head = () => (
        <Head>
          <link rel="stylesheet" href="/static/css/publicUser.css" />
        </Head>
      );
          ...
          <div
            ...
            >
              <div
                ...
                />
                      <div
                        className="public_profile_main_wrapper"
                        >
                          <div>
                            <img
                          ...
                          <div style={{display:'flex',flexDirection:'column'}}>
                            <div className="public_profile_name">
                                <h1>{profile.name}</h1>
                            </div>
                              <div className="public_profile_occupation">
                                  <h1>Email: <span style={{color:"rgba(0, 0, 0, 0.781)"}}>{profile.publishedEmail}</span> </h1>
                              </div>
                            <div className="public_profile_occupation">
                                <h1>Occupation: <span style={{color:"rgba(0, 0, 0, 0.781)"}}>{profile.occupation}</span> </h1>
                            </div>
                            <div className="public_profile_occupation">
                                <h1>Since: <span style={{color:"rgba(0, 0, 0, 0.781)"}}>{moment(profile.createdAt).format('LL')}</span> </h1>
                            </div>
                          </div>
                        </div>
                        <hr style={{width:'97%',height:'2px',marginTop:'5px',marginBottom:'5px'}}></hr>
                        <div className="public_profile_secondary_wrapper">
