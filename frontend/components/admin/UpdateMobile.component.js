    ...
    const editMobile = (e) => {
        ...
        updateMobile(formData, token, router.query.slug).then(data => {
            if (data.error) {
                ...
                setValues({ ...values, title: '', success: `A Mobile Titled "${data.title}" is successfully updated` });
                ...
                <div className="col-md-4 mb-5">
                    <div>
                        <div className="form-group pb-2">
                            ...
                            {body && <img className="img img-fluid" src={`${API}/mobile/photo/${router.query.slug}`} alt={title} style={{ width: '100%' }}></img>}
                            <hr />
