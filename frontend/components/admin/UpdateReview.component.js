    ...
    const editReview = (e) => {
        ...
        updateReview(formData, token, router.query.slug).then(data => {
            if (data.error) {
                ...
                setValues({ ...values, title: '', success: `A Review Titled "${data.title}" is successfully updated` });
                ...
                <div className="col-md-4 mb-5">
                    <div>
                        <div className="form-group pb-2">
                            ...
                            {body && <img className="img img-fluid" src={`${API}/reviews/photo/${router.query.slug}`} alt={title} style={{ width: '100%' }}></img>}
                            <hr />
