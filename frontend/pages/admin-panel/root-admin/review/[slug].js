...
import { removeReview, approveReview, unPublishReview } from '../../../../actions/review.action';
...
const SingleBlog = ({ review, query }) => {
    ...
    const approveButton = async () => {
        ...
        if (ask) {
            ...
            approveReview(query.slug, token).then(data => {
                if (data.error) {
                    setReviewPublicValues({ ...reviewPublicValues, postError: data.error })
                } else {
    ...
    const showUpdatedButton = (slug) => {
        return (
            <Link href={`/admin-panel/root-admin/review/update/${slug}`}>
                ...
                <div className="container">
                    <div className="row ml-0 mr-0">
                        <div className="col-md-12">
                            ...
                            {review.flag === 0 ? <button onClick={approveButton} className="container btn btn-sm btn-primary btn-block">Publish this post</button>
                                :
